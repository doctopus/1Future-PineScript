...
tf1hInput = input.bool(false, title="1h", group = "Timeframes", inline = "TFVH")
tf4hInput = input.bool(false, title="4h", group = "Timeframes", inline = "TFVH")
tf1dInput = input.bool(false, title="1D", group = "Timeframes", inline = "TFVH")
...
if orientationInput == 'Horizontal'
    ...
    for i = 0 to array.size(convictions_short) -1
        table.cell(infoTable, i + 1, 0, array.get(convictions_short, i), text_color = themeText, text_size = textSize) // Header for convictions
//
...
currentColumn := orientationInput == 'Horizontal' ? 0 : 0 // Start at row 1 for Horizontal (for labels), row 0 for Vertical
currentRow := orientationInput == 'Horizontal' ? 0 : maxRow +1 // Start at row 0 for Horizontal (for labels), row 1 for Vertical
// Initialize maxColumn and maxRow based on orientation
