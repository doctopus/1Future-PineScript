...
if (tf30sInput)
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 2: currentRow, convictionText_30s2,bgcolor=convictionBgColor_30s2, text_color=convictionTextColor_30s2, text_size = textSize)
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 3: currentRow,convictionText_30s3,bgcolor=convictionBgColor_30s3, text_color=convictionTextColor_30s3, text_size = textSize)
...
if (tf1mInput)
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 2: currentRow,convictionText_1m2,bgcolor=convictionBgColor_1m2,text_color=convictionTextColor_1m2, text_size = textSize)
    convictionType := "Ripster(34-50)"
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 3: currentRow,convictionText_1m3,bgcolor=convictionBgColor_1m3,text_color=convictionTextColor_1m3, text_size = textSize)
...
if (tf2mInput)
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 2: currentRow,convictionText_2m2, bgcolor=convictionBgColor_2m2, text_color=convictionTextColor_2m2, text_size = textSize)
    convictionType := "Ripster(34-50)"
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 3: currentRow,convictionText_2m3, bgcolor=convictionBgColor_2m3, text_color=convictionTextColor_2m3, text_size = textSize)
...
if (tf3mInput)
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 2: currentRow,convictionText_3m2,bgcolor=convictionBgColor_3m2, text_color=convictionTextColor_3m2, text_size = textSize)
    convictionType := "Ripster(34-50)"
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 3: currentRow,convictionText_3m3, bgcolor=convictionBgColor_3m3, text_color=convictionTextColor_3m3, text_size = textSize)
...
if (tf4mInput)
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 2: currentRow,convictionText_4m2,bgcolor=convictionBgColor_4m2, text_color=convictionTextColor_4m2, text_size = textSize)
    convictionType := "Ripster(34-50)"
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 3: currentRow,convictionText_4m3, bgcolor=convictionBgColor_4m3, text_color=convictionTextColor_4m3, text_size = textSize)
...
if (tf5mInput)
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 2: currentRow,convictionText_5m2, bgcolor=convictionBgColor_5m2, text_color=convictionTextColor_5m2, text_size = textSize)
    convictionType := "Ripster(34-50)"
    ...
    table.cell(infoTable,orientationInput == 'Horizontal' ? currentColumn : 1,orientationInput == 'Horizontal' ? 3: currentRow,convictionText_5m3, bgcolor=convictionBgColor_5m3, text_color=convictionTextColor_5m3, text_size = textSize)
// 6 Minute
// if (tf6mInput)
